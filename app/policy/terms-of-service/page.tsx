    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b bg-[#fafafa]">
        <div className="container px-4 py-3">
          <nav className="flex items-center justify-end gap-2 text-xs text-[#999]">
            ...
            <span>&gt;</span>
            <span className="font-medium text-[#333]">이용약관</span>
          </nav>
        </div>
      </div>
      ...
      <div className="container px-4 pb-20">
        <div className="mx-auto max-w-6xl text-xs leading-relaxed text-[#333] whitespace-pre-line">
          ...
          <p className="mb-4">** 해당 서식은 공정거래위원회에서 제공하는 전자상거래 표준 약관으로 쇼핑몰 운영형태에 따른 수정이 필요할 수 있습니다. 쇼핑몰에 적용하시기 전 쇼핑몰 운영 사항 등을 확인하시고 관련 법령 등을 감안하여 적절한 내용을 반영하여 이용하시기 바랍니다. **</p>

<p>제1조(목적)</p>
<p>이 약관은 농업회사법인 라이플로우(주) 회사(전자상거래 사업자)가 운영하는 주왕산가든(이하 &quot;몰&quot;이라 한다)에서 제공하는 인터넷 관련 서비스(이하 &quot;서비스&quot;라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
<p>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」</p>
<p>제2조(정의)</p>
<p>① &quot;몰&quot;이란 농업회사법인 라이플로우(주) 회사가 재화 또는 용역(이하 &quot;재화 등&quot;이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</p>
...
<p className="mt-4">제공받는 자 - (주)데이터라이즈</p>
<p>목적 - 사용자 행태 기반의 맞춤형 정보 제공. SMS, 카카오톡 채널 및 E-mail 등의 메시지 발송에 필요한 정보. 이벤트 전달 및 분석리포트 업무.</p>
<p>항목 - [일반] 이름, 아이디, 휴대폰번호, 이메일 주소</p>
<p>보유기간 - 계약종료시까지</p>

<p className="mt-4">부 칙(시행일) 이 약관은 24년 12월 15일부터 시행합니다.</p>
