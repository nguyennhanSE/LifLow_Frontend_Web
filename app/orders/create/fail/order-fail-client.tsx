    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-4">{t('key595', '결제 실패')}</h1>
          <p className="text-muted-foreground mb-8">
            {errorInfo?.message || t('key596', '결제 처리 중 오류가 발생했습니다.')}
          </p>

          {errorInfo && (
            <div className="bg-muted rounded-lg p-6 mb-8 text-left">
              <h2 className="font-semibold mb-4">{t('key597', '오류 상세')}</h2>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">{t('key598', '오류 코드:')}</span>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              {t('key599', '결제 정보를 확인하고 다시 시도해주세요.')}
            </p>
