      ...
      <div className="flex flex-col items-center mb-6">
        <div className="flex items-center gap-3">
          <Image
            ...
            height={36}
          />
          <h1 className="text-xl font-semibold text-black">{t('key318', '쭈왕몰 관리자')}</h1>
        </div>
        <p className="text-base text-black/80 mt-2">{t('key319', '관리자 로그인')}</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200/80 shadow-sm p-6 space-y-5">
        <div className="space-y-2">
          ...
          <Input
            id="admin-id"
            type="text"
            placeholder={t('id4', '관리자 ID를 입력하세요')}
