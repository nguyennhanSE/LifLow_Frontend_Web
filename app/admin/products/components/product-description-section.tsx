...
export function ProductDescriptionSection({
  ...
  return (
    <>
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="seoDescription">상세 설명</Label>
              <Textarea
                id="seoDescription"
                placeholder="SEO 설명을 입력해주세요 "
      ...
      <Card>
        <CardContent className="pt-6">
          <h2 className="mb-4 text-lg font-semibold">상세 이미지</h2>
          <div className="space-y-2">
              ...
              <div className="flex-1 space-y-2">
                <div className="rounded-lg border bg-muted/50 p-3">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {imageRegistrationDetail ? `${(imageRegistrationDetail.size / 1024).toFixed(2)} KB` : "권장 크기: 800 × 800px"}
                  </p>
                </div>
              </div>
            </div>
