    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>새로운 구폰을 생성합니다.</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 border-t pt-4">
              <Switch
                ...
                className="data-[state=checked]:bg-black"
              />
              <Label className="text-sm font-medium">등급별 자동 발급 (매달 1일)</Label>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                예: LV2. 새싹 선택 시 targetGrades에 &apos;LV2. 새싹&apos; 전송
              </p>
              ...
              {formData.targetGrades && formData.targetGrades.length > 0 && (
                <p className="text-xs text-muted-foreground">
                  선택된 등급: {formData.targetGrades.join(', ')}
                </p>
              )}
            </div>
