  ...
  return (
    <div className="min-h-screen bg-white flex justify-center items-center">
      ...
      <div className="w-xl max-w-4xl mx-auto px-4 py-8 bg-[#f5f5f5] rounded-2xl">
        ...
        <h1 className="text-3xl font-bold text-center mb-4">{t('key48', '아이디 찾기')}</h1>


        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
        <p className="text-center text-gray-600 mb-8 text-sm">
          {t('key76', '회원가입 시 입력하신 이름과 이메일을 입력해주세요.')}
        </p>
          {foundId ? (
            <div className="space-y-6 text-center">
              <div className="py-8">
                <p className="text-lg mb-4">{t('key77', '회원님의 아이디는')}</p>
